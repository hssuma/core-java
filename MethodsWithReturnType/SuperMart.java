class SuperMart 
{
	...
	{ 
		...
		{
            String brands[] = {"Britannia","Parle","Sunfeast","GoodDay","Marie","HideSeek","LittleHearts","MilkBikis","50-50",   "NiceTime","Bourbon","Monaco","KrackJack","Tiger","Treat","DarkFantasy","Oreo","JimJam", "NutriChoice","MilkCream","ButterDelite","ChocoFills","CashewCookies","AlmondCookies","CreamCracker","Salted","WheatDigestive","MultiGrain","HoneyOat","ChocoChip",  "FruitCookies","ElaichiCookies","CoconutCookies","ButterCookies","SugarFree"};
            return brands;
        }
		...
		if (productName == "stationery") {
			String brands[] = {"Classmate","Navneet","Camlin","Cello","Nataraj","Apsara","Staedtler","Paperkraft","Kokuyo","Pentonic","BBRoyal","Axiom","AddGel","Uniball","Sharpie","Maped","Montex","Hauser"};
			return brands;
		}
		...
		if(productName == "externalHDDBrands"){
		...
		if(productName == "lamp")
		{
			...
			return tableLampBrands;
		}
		if(productName == "bbcream")
		{
